...
@Entity
@Table(name = "PROMOTIONS_INFO")
public class PromotionsInfoResDao implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 713275236071756468L;

	@Id
	@Column(name = "PROMOTIONS_INFO_ID")
